...
```{r violinplot, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '100%', fig.align="center", fig.pos="H", fig.cap = "\\label{fig:violin}Violin plot of continuous variables."}
pdf(file="../thesis/images/violinplot.png", height=8, width=10)
...
pdf(file="../thesis/images/violinplot_standardized.png", height=8, width=10)
...
pdf(file="../thesis/images/heatmap.pdf", height=8, width=10)
...
pdf(file="../thesis/images/heatmap_standardized.pdf", height=8, width=10)
...
pdf(file="../thesis/images/pairsplot.pdf", height=8, width=10)
