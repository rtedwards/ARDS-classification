...
png(file="../thesis/images/missing_data_visualization.png", height=540, width=960)
...
```{r missing_data, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, fig.ext='png'}
vis_miss(data.raw.df, sort_miss = TRUE) +
  theme(  plot.margin = ggplot2::margin(0.125, 2, 0.5, 1, "cm") ) #top, right, bottom, left
```
...
png(file="../thesis/images/missing_data_visualization_var_dropped.png", height=540, width=960)
...
```{r violinplot-raw, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, fig.ext='png', out.width = '100%', fig.align="center", fig.pos="H", fig.cap = "\\label{fig:violin}Violin plot of continuous variables."}
data_standard.df %>% 
  gather(key = Feature, value = Value) %>% 
  ggplot(aes(x = Feature, y = Value, fill = Feature)) +
...
```{r violinplot-scaled, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, fig.ext='png', out.width = '100%', fig.align="center", fig.pos="H", fig.cap = "\\label{fig:violin}Violin plot of continuous variables."}
png(file="../thesis/images/violinplot.png", height=540, width=960)
...
```{r violinplot-transformed, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '100%', fig.align="center", fig.pos="H", fig.cap = "\\label{fig:violin2}Violin plot of continuous variables."}
png(file="../thesis/images/violinplot_standardized.png", height=540, width=960)

data_yeojohnson.df <- data.raw.df[, 5:ncol(data.raw.df)] %>%
  preProcess(method = c("center", "scale", "YeoJohnson"))

data_yeojohnson.df <- predict(data_yeojohnson.df, newdata = data.raw.df[, 5:ncol(data.raw.df)])

data_yeojohnson.df %>%
#  dplyr::select(5:ncol(data.raw.df)) %>% 
  gather(key = Feature, value = Value) %>% 
  ggplot(aes(x = Feature, y = Value, fill = Feature)) +
    geom_violin(scale = "width", 
                draw_quantiles = TRUE,
...
```{r heatmap, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, fig.ext='png', out.width = '100%', fig.align="center", fig.pos="H", fig.cap = "\\label{fig:cor}Correlation heatmap of contnuous variables."}
...
png(file="../thesis/images/heatmap.png", height=720, width=1280)
...
```{r heatmap-yeojohnson, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '100%', fig.align="center", fig.pos="H", fig.cap = "\\label{fig:cor}Correlation heatmap of contnuous variables."}
png(file="../thesis/images/heatmap_standardized.png", height=720, width=1280)

# Correlation matrix plot
ggcorr(data_yeojohnson.df, 
       hjust = 0.95, 
       size = 2, 
       label = TRUE, 
       label_size = 2, 
...
```{r pairsplot1, echo = FALSE, eval = FALSE, warning = FALSE, message = FALSE, fig.ext='png', out.width = '100%', fig.align="center", fig.pos="H", fig.cap = "\\label{fig:pairs}Pairs plot of continuous variables."}
...
png(file="../thesis/images/pairsplot.png", height=720, width=1280)
