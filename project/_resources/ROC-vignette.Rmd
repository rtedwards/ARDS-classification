...
```{r int-yes, eval = FALSE, fig.keep='none', results = 'asis', fig.width=7, fig.height=7}
cat(
  export_interactive_roc(basicplot, 
                        prefix = "a")
  )
...
```{r grp1, eval = FALSE, fig.keep='none', results = 'asis', fig.width=7, fig.height=7}
cat(
...
```{r grp3, eval = FALSE, fig.keep='none', results = 'asis', fig.width=12, fig.height=6}
cat(
