...
Kappa or Cohen’s Kappa is like classification accuracy, except that it is normalized at the baseline of random chance on your dataset. It is a useful performance measure on problems with imbalanced classes.  Cohen's Kappa is defined as:
...
```{r , echo = FALSE, eval = FALSE, fig.pos="H", fig.align = 'center', out.width = '100%', fig.cap = "\\label{fig:feature-importance-pca}Contribution of variables to the principal components whose cumulative sum >80%."}
load("../project/data/processed-data.RData")
require(FactoMineR) 
require(factoextra)
