...
\subsection{A. Additional Material}\label{a.-additional-material}
...
\subsection{B. Random Forests
Algorithm}\label{b.-random-forests-algorithm}
...
\subsection{C. R Code}\label{c.-r-code}
